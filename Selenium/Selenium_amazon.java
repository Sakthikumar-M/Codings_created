...
Choose Furniture
Search for chairs for computer table
Find the highest priced chair name displayed on page 1
(without using sort by price option given in the website)
Also print its number of 5 ratings
 */
